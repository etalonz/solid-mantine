...
const TestContainer = createContextContainer<any>(MenuItem, Menu, {
  opened: true,
});
...
describe("@mantine/core/MenuItem", () => {
  ...
  it("allows to add onMouseEnter and onMouseLeave events", async () => {
    ...
    render(() => (
      <TestContainer onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} />
    ));
  ...
  it("renders given icon and rightSection", () => {
    render(() => (
      <TestContainer icon="test-icon" rightSection="test-right-section" />
    ));
