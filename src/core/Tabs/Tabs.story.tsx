import { IconPackage } from "solid-tabler-icons";
...
const Wrapper = (props: TabsProps) => (
  <Tabs sx={{ maxWidth: 500 }} mx="auto" mt={40} {...props} />
);
...
export const Controlled = () => {
  const [tab, setTab] = createSignal("react");
  return (
...
export const DynamicTabs = () => {
  ...
  const panels = list.map((item) => (
    <Tabs.Panel value={item}>Panel {item}</Tabs.Panel>
  ));
