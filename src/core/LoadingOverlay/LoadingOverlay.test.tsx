import { itSupportsSystemProps, render, setupMatchMediaMock } from "testing";
...
describe("@mantine/core/LoadingOverlay", () => {
  ...
  it("renders based on visible prop", () => {
    const { container: notVisible } = render(() => (
    ...
    expect(
      visible.querySelector(".mantine-LoadingOverlay-root")
    ).toBeInTheDocument();
  });
});
