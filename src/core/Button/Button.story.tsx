import { MANTINE_COLORS, useMantineTheme } from "styles";
import { IconExternalLink } from "solid-tabler-icons";
...
export function Colors() {
  ...
  return (
    <div style={{ padding: "40px", "background-color": "rgba(0,0,0,0.1)" }}>
      {items}
    </div>
  );
}
