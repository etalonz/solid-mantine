...
describe("@mantine/core/MultiSelect/DefaultValue", () => {
  ...
  it("does not render delete button if disabled", () => {
    ...
    const { container: notDisabled } = render(() => (
      <DefaultValue {...defaultProps} disabled={false} />
    ));
  ...
  it("has correct displayName", () => {
    expect(DefaultValue.displayName).toStrictEqual(
      "@mantine/core/MultiSelect/DefaultValue"
    );
  });
});
