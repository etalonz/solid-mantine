...
export function StepIssue() {
  const [value1to9, setValue1to9] = createSignal(1);
  const [value0to9, setValue0to9] = createSignal(0);

  return (
    <div style={{ "max-width": "400px", padding: "40px" }}>
      <p>
        Odd number min and 2 per step. Should be 1, 3, 5, 7, 9. The dragging
        also seem to be lagging behind.
      </p>
      Value: {value1to9()}
      <Slider
        value={value1to9()}
