...
const defaultProps: BreadcrumbsProps = {
  children: [
    ...
    <Text<"a"> variant="link" component="a" href={item.href}>
      {item.title}
    </Text>
  )),
};
...
describe("@mantine/core/Breadcrumbs", () => {
  ...
  it("renders correct amount of children and separators", () => {
    ...
    expect(
      container.querySelectorAll(".mantine-Breadcrumbs-breadcrumb")
    ).toHaveLength(3);
    expect(
      container.querySelectorAll(".mantine-Breadcrumbs-separator")
    ).toHaveLength(2);
  });
