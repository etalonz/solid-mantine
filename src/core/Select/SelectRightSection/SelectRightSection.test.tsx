...
describe("@mantine/core/SelectRightSection", () => {
  it("renders ChevronIcon when shouldClear is false", () => {
    const { container } = render(() => (
      <SelectRightSection shouldClear={false} size="sm" />
    ));
  ...
  it("renders CloseButton when shouldClear is true", () => {
    const { container } = render(() => (
      <SelectRightSection shouldClear size="sm" />
    ));
  ...
  it("has correct displayName", () => {
    expect(SelectRightSection.displayName).toStrictEqual(
      "@mantine/core/SelectRightSection"
    );
  });
});
