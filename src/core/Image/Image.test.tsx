...
describe("@mantine/core/Image", () => {
  ...
  it("sets given width, height and object-fit on img element", () => {
    render(() => (
      <Image {...defaultProps} width={"478px"} height={"207px"} fit="contain" />
    ));
  ...
  it("renders placeholder based on withPlaceholder prop", () => {
    const { container: withPlaceholder } = render(() => (
      <Image src={null} withPlaceholder />
    ));
    const { container: withoutPlaceholder } = render(() => (
      <Image src={null} withPlaceholder={false} />
    ));
    expect(
      withPlaceholder.querySelectorAll(".mantine-Image-placeholder")
    ).toHaveLength(1);
    expect(
      withoutPlaceholder.querySelectorAll(".mantine-Image-placeholder")
    ).toHaveLength(0);
  });
  ...
  it("renders given caption", () => {
    ...
    const { container: withCaption } = render(() => (
      <Image src="test" caption="test-caption" />
    ));
